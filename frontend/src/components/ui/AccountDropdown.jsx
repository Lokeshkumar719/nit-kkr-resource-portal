...
export function AccountDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-1.5 z-50 animate-fade-in origin-top-right transform transition-all">
          ...
          <div className="px-1.5 py-1.5">
            <button className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-700 font-medium hover:bg-slate-50 hover:text-nit-primary rounded-lg transition-colors text-left">
