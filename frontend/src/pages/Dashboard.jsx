      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-nit-primary via-nit-primary-light to-blue-700 p-8 sm:p-10 text-white">
        <div className="relative z-10">
          ...
          <p className="text-blue-200/80 max-w-lg text-sm sm:text-base leading-relaxed">
            Your academic resource hub at NIT Kurukshetra. Browse materials, connect with seniors,
            and explore the alumni network.
          </p>
        </div>
        {/* Decorative circles */}
          ...
          {dashboardOptions.map((opt, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-5">
                  <div
                    className={`w-11 h-11 rounded-xl bg-gradient-to-br ${opt.gradient} flex items-center justify-center mb-4 shadow-lg ${opt.shadow} group-hover:scale-105 transition-transform duration-300`}
                  >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed mb-4">{opt.desc}</p>
