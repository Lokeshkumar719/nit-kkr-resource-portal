...
export default function Contribute() {
  ...
  useEffect(() => {
    if (branch && semester) {
      resourceApi
        .getByBranchAndSem(branch, semester)
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Help improve the platform or share useful academic resources with fellow students.
          </p>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-1 group-hover:text-nit-primary transition-colors">
              Report a Bug
            </h3>
            <p className="text-sm text-slate-500 mb-6 leading-relaxed">
              Found something broken? Tell us what went wrong so we can fix it.
            </p>
        ...
        >
          ...
          <div className="p-6 flex-1 flex flex-col">
            ...
            <p className="text-sm text-slate-500 mb-6 leading-relaxed">
              Share notes, books, PYQs, and lecture links to help fellow students.
            </p>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Select the resource category you'd like to share with fellow students.
          </p>
        </div>
      </div>
          ...
          {submitted ? (
            <div className="text-center py-10 animate-fade-in">
              ...
              <div className="flex items-center justify-center gap-3">
                <button
                  onClick={handleBack}
                  className="text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors px-4 py-2 rounded-lg hover:bg-gray-50"
                >
                  Back to Contributions
                </button>
                <button
                  ...
                  className="text-sm font-semibold text-white bg-nit-primary hover:bg-blue-900 transition-colors px-4 py-2 rounded-lg shadow-sm"
                >
                  Submit another
                </button>
              </div>
  ...
  return (
    <div className="pb-10">
      ...
      {(view === 'notes' || view === 'book' || view === 'pyq' || view === 'lecture') &&
        renderUploadForm()}
    </div>
  );
}
